        ...
        <main class="googleMap">
            ...
            <div id="card" class="card text-white bg-primary w-100 hide">
                <div id="cardInfo">
                    ...
                    <h6 id="placeAddress" class="card-text ml-3"></h6>
                    <div id="cardBody" class="card-body">
                        <h3 id="overallRating">Overall Rating:
                            <c:if test="${avgRating1 == 0}">
                        ...
                        <form class="d-inline-block" action="/allReviews" method="post">
                            <input id="hiddenId2" type="hidden" name="hiddenId" value="${hiddenId}">
                            <input id="hiddenName2" type="hidden" name="hiddenName" value="${hiddenName}">
                            <input id="hiddenAddress2" type="hidden" name="hiddenAddress" value="${hiddenAddress}">
                            <button type="submit" class="btn btn-secondary">All Reviews</button>
                        </form>
                        <form class="d-inline-block" action="/newRating" method="post">
                            <input id="hiddenId" type="hidden" name="hiddenId" value="${hiddenId}">
                            <input id="hiddenName" type="hidden" name="hiddenName" value="${hiddenName}">
                            <input id="hiddenAddress" type="hidden" name="hiddenAddress" value="${hiddenAddress}">
